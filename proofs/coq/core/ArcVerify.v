...
From ArcProofs Require Import ArcTypes ArcMerkle ArcAuthority ArcPolicy.

Definition object_bound_to_state (obj : ArcObject) (state : AuthorityState) : bool :=
...
Definition verify_open_context (obj : ArcObject) (cap : Capability) (state : AuthorityState) : bool :=
