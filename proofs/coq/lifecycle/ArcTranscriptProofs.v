...
From ArcProofs Require Import ArcTypes ArcMerkle ArcAuthority ArcPolicy ArcVerify ArcSecurityGame ArcTheorems ArcStressProofs ArcDelegationProofs ArcCryptoReduction ArcTemporalProofs.

Record ArcTranscript := {
...
Definition transcript_matches_object (tr : ArcTranscript) (obj : ArcObject) : bool :=
...
Definition transcript_matches_state (tr : ArcTranscript) (state : AuthorityState) : bool :=
...
Definition transcript_matches_capability (tr : ArcTranscript) (cap : Capability) : bool :=
