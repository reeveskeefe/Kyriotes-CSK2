...
Definition current_arc_refinement_obligations : list RustRefinementObligation :=
  [
    {| obligation_module := RustEncoding; obligation_symbol := "decode_arc_object"; obligation_property := "Rust decoder refines Coq codec model"; obligation_strength := ConceptMapped; obligation_satisfied := false |};
...
Theorem current_obligations_have_no_implementation_checked_item :
  obligations_have_implementation_checked_item current_arc_refinement_obligations = false.
Proof.
  reflexivity.
Qed.
