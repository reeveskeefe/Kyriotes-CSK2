...
Definition kyriotes_csk2_seal_mechanical_vectors : list SealMechanicalVector :=
  [
    {|
...
Definition kyriotes_csk2_current_seal_refinement_status : SealRustRefinementStatus :=
  {|
...
Theorem current_seal_vectors_complete :
  seal_vectors_complete kyriotes_csk2_seal_mechanical_vectors = true.
Proof.
  reflexivity.
Qed.
...
Definition kyriotes_csk2_full_mechanical_proof_gate_after_seal_check : KyriotesCsk2FullMechanicalProofGate :=
  {|
