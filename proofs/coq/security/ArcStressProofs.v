...
From ArcProofs Require Import ArcTypes ArcMerkle ArcAuthority ArcPolicy ArcVerify ArcSecurityGame ArcTheorems.
...
Proof.
  ...
  pose proof (arc_verified_open_implies_exact_authority_binding obj cap state H_open) as [H_equal _].
  contradiction.
Qed.
...
Proof.
  intros obj cap state H_open H_mismatch.
  pose proof (arc_verified_open_implies_exact_authority_binding obj cap state H_open) as [_ [H_equal _]].
  contradiction.
Qed.
...
Proof.
  intros obj cap state H_open H_mismatch.
  pose proof (arc_verified_open_implies_exact_authority_binding obj cap state H_open) as [_ [_ [H_equal _]]].
  contradiction.
Qed.
...
Proof.
  intros obj cap state H_open H_mismatch.
  pose proof (arc_verified_open_implies_exact_authority_binding obj cap state H_open) as [_ [_ [_ H_equal]]].
  contradiction.
Qed.
...
Proof.
  intros obj cap state H_open H_mismatch.
  pose proof (arc_verified_open_implies_object_authorization obj cap state H_open) as [H_equal _].
  contradiction.
Qed.
...
Proof.
  intros obj cap state H_open H_bad.
  pose proof (arc_verified_open_implies_object_authorization obj cap state H_open) as [_ [H_equal _]].
  contradiction.
Qed.
...
Proof.
  intros obj cap state H_open H_bad.
  pose proof (arc_verified_open_implies_object_authorization obj cap state H_open) as [_ [_ [H_start _]]].
  lia.
Qed.
...
Proof.
  intros obj cap state H_open H_bad.
  pose proof (arc_verified_open_implies_object_authorization obj cap state H_open) as [_ [_ [_ H_end]]].
  lia.
Qed.
