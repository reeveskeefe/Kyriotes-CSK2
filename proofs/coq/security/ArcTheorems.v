...
From ArcProofs Require Import ArcTypes ArcMerkle ArcAuthority ArcPolicy ArcVerify ArcSecurityGame.

Theorem arc_verified_open_safety :
...
Theorem arc_verified_open_implies_exact_authority_binding :
  forall obj cap state,
    verify_open_context obj cap state = true ->
...
Theorem arc_verified_open_implies_object_authorization :
  forall obj cap state,
    verify_open_context obj cap state = true ->
...
Theorem arc_verified_open_excludes_revocation_leaf :
  forall obj cap state,
    verify_open_context obj cap state = true ->
