...
From KyriotesCsk2Proofs Require Import KyriotesCsk2Types KyriotesCsk2Merkle KyriotesCsk2Authority KyriotesCsk2Policy KyriotesCsk2Verify KyriotesCsk2SecurityGame KyriotesCsk2Theorems KyriotesCsk2StressProofs KyriotesCsk2DelegationProofs.
...
Definition kyriotes_csk2_authorized_open (obj : KyriotesCsk2Object) (cap : Capability) (state : AuthorityState) : bool :=
  verify_open_context obj cap state.

Definition kyriotes_csk2_unauthorized_open_attempt (obj : KyriotesCsk2Object) (cap : Capability) (state : AuthorityState) : bool :=
  verify_open_context obj cap state && unauthorized_capability cap obj.

Definition kyriotes_csk2_context_substitution_attempt (obj : KyriotesCsk2Object) (cap : Capability) (state : AuthorityState) : bool :=
  verify_open_context obj cap state &&
  negb (object_bound_to_state obj state).

Definition kyriotes_csk2_revocation_bypass_attempt (obj : KyriotesCsk2Object) (cap : Capability) (state : AuthorityState) : bool :=
  verify_open_context obj cap state &&
  negb (capability_not_revoked cap state).

Definition kyriotes_csk2_authority_inclusion_bypass_attempt (obj : KyriotesCsk2Object) (cap : Capability) (state : AuthorityState) : bool :=
  verify_open_context obj cap state &&
  negb (capability_in_authority_root cap state).

Definition kyriotes_csk2_policy_bypass_attempt (obj : KyriotesCsk2Object) (cap : Capability) (state : AuthorityState) : bool :=
  verify_open_context obj cap state &&
  negb (policy_accepts cap obj).

Definition kyriotes_csk2_confidentiality_break_without_primitives
...
Theorem kyriotes_csk2_authorized_open_implies_policy_authorized :
  forall obj cap state,
    kyriotes_csk2_authorized_open obj cap state = true ->
    unauthorized_capability cap obj = false.
Proof.
  intros obj cap state H.
  unfold kyriotes_csk2_authorized_open in H.
  apply no_unauthorized_verified_open with (state := state).
  exact H.
Qed.

Theorem kyriotes_csk2_unauthorized_open_attempt_impossible :
  forall obj cap state,
    kyriotes_csk2_unauthorized_open_attempt obj cap state = false.
Proof.
  intros obj cap state.
  unfold kyriotes_csk2_unauthorized_open_attempt.
  destruct (verify_open_context obj cap state) eqn:H_open.
  - pose proof (kyriotes_csk2_authorized_open_implies_policy_authorized obj cap state H_open) as H_unauth.
    rewrite H_unauth.
    reflexivity.
  - reflexivity.
Qed.

Theorem kyriotes_csk2_context_substitution_attempt_impossible :
  forall obj cap state,
    kyriotes_csk2_context_substitution_attempt obj cap state = false.
Proof.
  intros obj cap state.
  unfold kyriotes_csk2_context_substitution_attempt.
  destruct (verify_open_context obj cap state) eqn:H_open.
...
Theorem kyriotes_csk2_revocation_bypass_attempt_impossible :
  forall obj cap state,
    kyriotes_csk2_revocation_bypass_attempt obj cap state = false.
Proof.
  intros obj cap state.
  unfold kyriotes_csk2_revocation_bypass_attempt.
  destruct (verify_open_context obj cap state) eqn:H_open.
...
Theorem kyriotes_csk2_authority_inclusion_bypass_attempt_impossible :
  forall obj cap state,
    kyriotes_csk2_authority_inclusion_bypass_attempt obj cap state = false.
Proof.
  intros obj cap state.
  unfold kyriotes_csk2_authority_inclusion_bypass_attempt.
  destruct (verify_open_context obj cap state) eqn:H_open.
...
Theorem kyriotes_csk2_policy_bypass_attempt_impossible :
  forall obj cap state,
    kyriotes_csk2_policy_bypass_attempt obj cap state = false.
Proof.
  intros obj cap state.
  unfold kyriotes_csk2_policy_bypass_attempt.
  destruct (verify_open_context obj cap state) eqn:H_open.
...
Theorem kyriotes_csk2_confidentiality_break_without_primitives_impossible :
  forall obj cap state breaks,
    kyriotes_csk2_confidentiality_break_without_primitives obj cap state breaks = false.
Proof.
  intros obj cap state breaks.
  unfold kyriotes_csk2_confidentiality_break_without_primitives.
  destruct (verify_open_context obj cap state) eqn:H_open.
  - pose proof (kyriotes_csk2_authorized_open_implies_policy_authorized obj cap state H_open) as H_unauth.
    rewrite H_unauth.
    reflexivity.
...
Theorem kyriotes_csk2_verified_open_or_primitive_break_reduction_shape :
  forall obj cap state breaks,
...
Proof.
  ...
  pose proof (kyriotes_csk2_authorized_open_implies_policy_authorized obj cap state H_open) as H_not_unauth.
  rewrite H_not_unauth in H_unauth.
  discriminate.
Qed.

Theorem kyriotes_csk2_context_binding_reduction_shape :
  forall obj cap state breaks,
    verify_open_context obj cap state = true ->
...
Theorem kyriotes_csk2_revocation_reduction_shape :
  forall obj cap state breaks,
    verify_open_context obj cap state = true ->
...
Theorem kyriotes_csk2_authority_inclusion_reduction_shape :
  forall obj cap state breaks,
    verify_open_context obj cap state = true ->
...
Theorem kyriotes_csk2_policy_reduction_shape :
  forall obj cap state breaks,
    verify_open_context obj cap state = true ->
...
Theorem kyriotes_csk2_successful_unauthorized_open_requires_failed_assumption_shape :
  forall obj cap state breaks,
    verify_open_context obj cap state = true ->
    unauthorized_capability cap obj = true ->
...
Theorem kyriotes_csk2_no_auth_bypass_under_no_primitive_breaks :
  forall obj cap state breaks,
    no_primitive_breaks breaks = true ->
    kyriotes_csk2_unauthorized_open_attempt obj cap state = false /\
    kyriotes_csk2_context_substitution_attempt obj cap state = false /\
...
Proof.
  ...
  repeat split.
  - apply kyriotes_csk2_unauthorized_open_attempt_impossible.
  - apply kyriotes_csk2_context_substitution_attempt_impossible.
  - apply kyriotes_csk2_revocation_bypass_attempt_impossible.
  - apply kyriotes_csk2_authority_inclusion_bypass_attempt_impossible.
  - apply kyriotes_csk2_policy_bypass_attempt_impossible.
  - apply kyriotes_csk2_confidentiality_break_without_primitives_impossible.
Qed.
