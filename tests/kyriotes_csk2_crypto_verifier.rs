...
use kyriotes_csk2::{
    AuthorityRootKeyPair, CryptoAuthorityVerifier, EpochSigningKeyPair, InMemoryTransparencyLog,
    KyriotesCsk2Error, TransparencyLog, open_with_verifier, seal_with_verifier,
};
...
fn signed_verifier_for_state(
    state: &kyriotes_csk2::AuthorityState,
    root_seed: u8,
    epoch_seed: u8,
