...
/// - A properly delegated capability can be used to seal and open an Kyriotēs-CSK2 object
...
use kyriotes_csk2::{
    ...
    KyriotesCsk2Error, MAX_DELEGATION_DEPTH, Rights, TemporalPolicy, capability_leaf_hash,
    capability_stamp, delegate_capability, open, seal,
};
...
/// tree, and the sub-delegatee successfully seals and opens an Kyriotēs-CSK2 object.
#[test]
fn delegated_cap_seal_open_e2e() {
    ...
    let recipient = kyriotes_csk2::RecipientKeyPair::generate(&mut rng);
