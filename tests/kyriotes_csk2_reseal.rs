...
///
/// Reseal produces a new Kyriotēs-CSK2 object with a fresh DEK and optionally a new
...
use kyriotes_csk2::{
    KyriotesCsk2Error, RecipientKeyPair, TemporalPolicy, open, open_and_reseal, seal,
};
...
fn reseal_cross_epoch_with_new_state() {
    ...
    let seal_req48 = kyriotes_csk2::OpenRequest {
    ...
    assert!(
        matches!(
            ...
            KyriotesCsk2Error::MissingWrapper
                | KyriotesCsk2Error::AuthorityState(_)
                | KyriotesCsk2Error::InvalidCapability(_)
