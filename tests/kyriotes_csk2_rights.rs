...
///
/// Kyriotēs-CSK2 requires cap.rights ⊇ req.required_rights for both seal and open.
...
use kyriotes_csk2::{
    AuthorityState, Capability, InMemoryTransparencyLog, KyriotesCsk2Error, OpenRequest,
    RecipientKeyPair, Rights, TemporalPolicy, open, seal,
};
...
fn setup(
    ...
    TestAuthority,
    AuthorityState,
    kyriotes_csk2::TransparencyProof,
    kyriotes_csk2::CapabilityProof,
) {
...
fn seal_rejects_when_cap_rights_insufficient() {
    ...
    assert!(
        matches!(
            err,
            KyriotesCsk2Error::InvalidCapability("insufficient rights")
        ),
