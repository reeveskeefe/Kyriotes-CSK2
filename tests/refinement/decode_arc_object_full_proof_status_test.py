...
STATUS_PATH = PROJECT_ROOT / "tests" / "refinement" / "decode_arc_object_full_proof_status.json"


def main() -> int:
    payload = json.loads(STATUS_PATH.read_text(encoding="utf-8"))

    assert payload["schema"] == "arc.decode_arc_object.full_mechanical_proof_status.v1"
    ...
    print("decode_arc_object full proof status test passed.")
    return 0
