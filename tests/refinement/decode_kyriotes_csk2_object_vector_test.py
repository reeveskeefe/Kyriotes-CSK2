#!/usr/bin/env python3
"""
Parser-refinement vector test for decode_kyriotes_csk2_object.
"""
...
VECTOR_PATH = PROJECT_ROOT / "tests" / "refinement" / "decode_kyriotes_csk2_object_vectors.json"
...
def main() -> int:
    ...
    assert payload["schema"] == "arc.decode_kyriotes_csk2_object.refinement_vectors.v1"
    assert payload["target"] == "src/encoding/wire.rs::decode_kyriotes_csk2_object"
    ...
    print("decode_kyriotes_csk2_object vector test passed.")
    return 0
