...
STATUS_PATH = PROJECT_ROOT / "tests" / "refinement" / "encode_kyriotes_csk2_object_full_proof_status.json"
...
def main() -> int:
    ...
    assert payload["schema"] in {
        "arc.encode_kyriotes_csk2_object.full_mechanical_proof_status.v1",
        "arc.encode_kyriotes_csk2_object.full_mechanical_proof_status.v2",
    }
    ...
    print("encode_kyriotes_csk2_object full proof status test passed.")
    return 0
