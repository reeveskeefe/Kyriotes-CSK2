#!/usr/bin/env python3
"""
Checks that encode_kyriotes_csk2_object is marked mechanically checked and not mechanically proven.
"""
...
def main() -> int:
    ...
    matches = [
        ...
        if entry["id"] == "codec.encode_kyriotes_csk2_object"
    ]
    ...
    print("encode_kyriotes_csk2_object mechanical target test passed.")
    return 0
