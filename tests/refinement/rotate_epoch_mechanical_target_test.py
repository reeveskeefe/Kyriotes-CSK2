...
def main() -> int:
    ...
    assert "authority-epoch refinement track" in item["boundary"]

    print("rotate_epoch mechanical target test passed.")
    return 0
